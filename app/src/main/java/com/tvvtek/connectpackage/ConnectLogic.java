...
public class ConnectLogic implements ConnectLogicInterface {
    ...
    */}
    ...
    public synchronized String toWork(){
        if(script_name !=null) {
            try {
                ...
                // parse array setRequest and make body for send server
                ...
                response = client.newCall(request).execute(); // this stop code till data received from server
     ...
     */
    @Override
    public synchronized int getStateRequest(){
